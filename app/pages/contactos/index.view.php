                ...
                <tbody>
                    <?php foreach ($contactos as $contacto) : ?>
                        <tr>
                            ...
                            <td><a name="" id="" class="btn btn-info" href="/contactos/editar/<?php echo $contacto['id']; ?>" role="button">Editar</a> | <a name="" id="" class="btn btn-danger" href="/contactos/<?php echo $contacto['id']; ?>" role="button">Borrar</a></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
